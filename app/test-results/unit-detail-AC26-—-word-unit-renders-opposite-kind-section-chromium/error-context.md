...
- Name: unit-detail.spec.ts >> AC26 — word unit renders opposite-kind section
- Location: tests/unit-detail.spec.ts:128:1
...
Locator: locator('[data-testid="unit-type"]')
Expected substring: "word"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('[data-testid="unit-type"]')
