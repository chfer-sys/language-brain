...
- Name: _repro-compound-nav.spec.ts >> _repro — compound unit loads and shows Connections section
- Location: tests/_repro-compound-nav.spec.ts:23:1
...
Locator: locator('[data-testid="unit-name"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="unit-name"]')
