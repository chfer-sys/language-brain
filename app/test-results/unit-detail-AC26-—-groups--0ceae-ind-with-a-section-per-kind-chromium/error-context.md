...
- Name: unit-detail.spec.ts >> AC26 — groups connections by kind with a section per kind
- Location: tests/unit-detail.spec.ts:114:1
...
Locator: locator('[data-testid="connections-kind-lexical"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="connections-kind-lexical"]')
