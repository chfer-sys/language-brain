...
- Name: add-page.spec.ts >> T2 — sends edited antonym chips (hanzi) to commitSentence
- Location: tests/add-page.spec.ts:252:1
...
Locator: locator('[data-testid="antonyms-chip-饱"]')
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="antonyms-chip-饱"]')
