...
- Name: unit-detail.spec.ts >> AC27 — word page shows empty-state when no sentences contain it
- Location: tests/unit-detail.spec.ts:150:1
...
Locator: locator('[data-testid="containing-sentences"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="containing-sentences"]')
