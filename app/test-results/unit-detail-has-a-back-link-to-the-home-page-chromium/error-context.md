...
- Name: unit-detail.spec.ts >> has a back link to the home page
- Location: tests/unit-detail.spec.ts:174:1
...
Locator: locator('[data-testid="back-link"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="back-link"]')
