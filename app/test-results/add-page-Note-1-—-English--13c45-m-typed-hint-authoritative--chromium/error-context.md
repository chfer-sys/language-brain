...
- Name: add-page.spec.ts >> Note 1 — English field pre-filled from typed hint (authoritative)
- Location: tests/add-page.spec.ts:137:1
...
Locator: locator('[data-testid="english-input"]')
Expected: "drooling over food"
Timeout: 3000ms
Error: element(s) not found

Call log:
  - Expect "toHaveValue" with timeout 3000ms
  - waiting for locator('[data-testid="english-input"]')
