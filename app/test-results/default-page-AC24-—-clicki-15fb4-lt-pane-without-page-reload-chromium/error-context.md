...
- Name: default-page.spec.ts >> AC24 — clicking a unit-type filter updates result pane without page reload
- Location: tests/default-page.spec.ts:108:1
...
- generic [ref=e2]:
  ...
  - generic [ref=e12]:
    ...
    - group "Unit-type filters" [ref=e19]:
      ...
      - button "sent" [active] [ref=e21] [cursor=pointer]
