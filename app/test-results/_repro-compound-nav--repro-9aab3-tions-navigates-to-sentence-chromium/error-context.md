...
- Name: _repro-compound-nav.spec.ts >> _repro — clicking sentence link in compound Connections navigates to sentence
- Location: tests/_repro-compound-nav.spec.ts:49:1
...
Locator: locator('[data-testid="connections-kind-lexical"] a[href="/unit/S29"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="connections-kind-lexical"] a[href="/unit/S29"]')
