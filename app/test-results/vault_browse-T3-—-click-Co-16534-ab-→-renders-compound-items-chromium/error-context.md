...
- Name: vault_browse.spec.ts >> T3 — click Compound tab → renders compound items
- Location: tests/vault_browse.spec.ts:103:1
...
Call log:
  - waiting for locator('[role="tab"][data-type="compound"]')
    - locator resolved to <button role="tab" type="button" data-type="compound" aria-selected="false" class="tab s-NKwX_-hddHxy">Compound</button>
