...
This file is project-level rules read by every agent (orchestrator, plan, executor, debug) working in this repo. The harness-level constitution lives at `~/.config/opencode/AGENTS.md` and is composed with this file.
